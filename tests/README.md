...
|---|---|---|
| [BID-01.md](BID-01.md) | Tiếp nhận thư chào thầu | 10 + 25 |
| [BID-02.md](BID-02.md) | Thẩm định BOQ liên phòng ban | 11 + 22 |
| [BID-03.md](BID-03.md) | Áp giá, gửi báo giá & thương thảo | 14 + 33 |
| [BID-04.md](BID-04.md) | Huỷ gói thầu & thông báo các bộ phận | 5 + 7 |
| [BID-05.md](BID-05.md) | Ký hợp đồng & khởi tạo dự án | 9 + 30 |
...
| Tệp | Màn hình | Số kịch bản (A + B) |
|---|---|---|
| [PRJ-01.md](PRJ-01.md) | Giá khoán tổ đội | 8 + 9 |
...
1. **Dòng gói thầu → dự án**: BID-01 tiếp nhận và số hoá BOQ → BID-02 hai phiếu thẩm định hợp nhất thành BOQ v2 → BID-03 áp giá, gửi báo giá, chốt giá → BID-05 kiểm tra trước ký, ký số, khởi tạo dự án (sinh kho ở ACC-02, WBS cho PRJ-02, đợt thanh toán cho ORD-01). Nhánh rẽ: BID-03 trượt thầu → BID-04.
...
6. **Dòng đối chiếu biên lợi nhuận**: BID-03 chốt giá (lưu biên dự thầu) → PRJ-02 sản lượng → ACC-09 giá thành thực tế → RPT-03 đối chiếu biên dự thầu ↔ biên thực tế.
